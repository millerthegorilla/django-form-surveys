...
def surveys_context(request):
    context = {
        ...
        "SURVEY_FORM_SUCCESS_TIMEOUT": app_settings.SURVEY_FORM_SUCCESS_TIMEOUT,
        ...
        "SURVEY_LOGIN_URL": app_settings.SURVEY_LOGIN_URL,
        "SURVEY_SCREENSAVER_TIMEOUT": app_settings.SURVEY_SCREENSAVER_TIMEOUT,
        "SURVEY_SCREENSAVER_TEXT": app_settings.SURVEY_SCREENSAVER_TEXT,
    }
    return context
