...
urlpatterns = [
    ...
    path(
        "survey_selection_list/",
        views.SurveySelectionListView.as_view(),
        name="survey_selection_list",
    ),
    path(
        "detail/result/<int:pk>/",
        views.DetailResultSurveyView.as_view(),
        name="detail_result",
    ),
    path(
        "detail/<str:slug>/<str:selection_slug>/",
        views.DetailSurveyView.as_view(),
        name="detail",
    ),
    ...
    path(
        "selection_share/<str:slug>/",
        views.selection_share_link,
        name="selection_share_link",
    ),
    path(
