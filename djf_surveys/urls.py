...
urlpatterns = [
    ...
    path('respond/<str:slug>/<str:selection_slug>/', views.RespondSurveyFormView.as_view(), kwargs={'temp_login':'False'}, name='respond'),
    path('respond/<str:slug>/<str:selection_slug>/<str:temp_login>/', views.RespondSurveyFormView.as_view(), name='respond'),
    ...
    path('success/<str:slug>/<str:selection_slug>/', views.SuccessPageSurveyView.as_view(), kwargs={'temp_login': 'False'}, name='success'),
    path('success/<str:slug>/<str:selection_slug>/<str:temp_login>/', views.SuccessPageSurveyView.as_view(), name='success'),
