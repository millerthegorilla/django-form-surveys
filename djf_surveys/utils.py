...
def create_star(active_star: int, num_stars: int = 5, id_element: str = "") -> str:
    ...
    elements = [
        f'<div class="tw:flex tw:content-center" id="parent_start_{id_element}">'
    ]
    for star in range(int(active_star)):
        elements.append('<i class ="rating__star rating_active"> </i>')
    for star in range(inactive_star):
...
def get_type_field():
    return [
        {"id": models.TYPE_FIELD.text, "label": _("Text"), "icon": "bi bi-type"},
        {"id": models.TYPE_FIELD.number, "label": _("Number"), "icon": "bi bi-123"},
        {"id": models.TYPE_FIELD.radio, "label": _("Radio"), "icon": "bi bi-ui-radios"},
        {
        ...
        {"id": models.TYPE_FIELD.url, "label": _("URL"), "icon": "bi bi-link"},
        {"id": models.TYPE_FIELD.email, "label": _("Email"), "icon": "bi bi-envelope"},
        {
